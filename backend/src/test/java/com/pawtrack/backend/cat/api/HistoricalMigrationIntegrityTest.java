...
class HistoricalMigrationIntegrityTest {
    @Test
    void v1ThroughV6RemainIdenticalToPortfolioCoreTag() throws Exception {
        // Frozen v1.0-portfolio-core contents; normalize Git's platform-specific CRLF conversion.
        var frozen = Map.of(
