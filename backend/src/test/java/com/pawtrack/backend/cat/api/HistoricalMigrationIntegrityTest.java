...
class HistoricalMigrationIntegrityTest {
    @Test
    void v1ThroughV8RemainUnchanged() throws Exception {
        // V1-V6: frozen portfolio tag; V7/V8: completed P3 baselines. Normalize Git CRLF conversion.
        var frozen = Map.of(
                ...
                "V8__remove_legacy_cat_status.sql", "69231ff262260b26a036392da3d8144555e88ac6cffbd2935899e01e668b21de");
