...
@EntityScan(basePackages = {"com.pawtrack.backend.cat", "com.pawtrack.backend.adoption",
        "com.pawtrack.backend.alert", "com.pawtrack.backend.healthdata", "com.pawtrack.backend.care"})
@EnableJpaRepositories(basePackages = {"com.pawtrack.backend.cat", "com.pawtrack.backend.adoption",
        "com.pawtrack.backend.alert", "com.pawtrack.backend.healthdata", "com.pawtrack.backend.care"})
